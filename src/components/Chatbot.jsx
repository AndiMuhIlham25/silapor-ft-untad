...
const FAQ = [
  ...
  { key: "ngadu", kw: ["cara ngadu", "cara buat", "cara lapor", "cara mengadu", "buat aduan", "mengadu", "melapor", "ngadu", "kirim aduan", "gimana lapor"],
    a: "Cara buat aduan: di halaman Beranda, isi Nama, Stambuk/NIP, Prodi, pilih Peran & Kategori, lalu tulis deskripsi kendalamu dan klik Kirim. Kamu juga bisa lampirkan file (pdf/jpg/png, maks 1 MB). Setelah kirim, kamu dapat ID Aduan untuk melacak status." },
  ...
  { key: "privasi", kw: ["privasi", "identitas", "nama saya", "rahasia", "disamarkan", "aman ga", "data saya"],
    a: "Tenang, di halaman Hasil Laporan publik identitas pelapor disamarkan (misal 'Andi R.'), dan Stambuk tidak ditampilkan. Data lengkap hanya dilihat admin yang menangani." },
