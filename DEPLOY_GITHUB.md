...
2. Di folder project, jalankan:
   ...
   git branch -M main
   git remote add origin https://github.com/USERNAME/silapor-ft-untad.git
...
4. URL muncul di: repo → tab **Actions** (job Deploy) atau **Settings → Pages**.
   Formatnya: `https://USERNAME.github.io/silapor-ft-untad/`
...
4. Tunggu 1-2 menit, buka `https://USERNAME.github.io/silapor-ft-untad/`.
